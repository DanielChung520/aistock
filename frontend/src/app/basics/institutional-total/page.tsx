...
export default function InstitutionalTotalPage() {
  const [data, setData] = useState<InstitutionalRow[]>([])
    ...
    <AppShell>
      <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-4 md:space-y-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-2 md:mb-6">
          <div>
            <h1 className="text-xl md:text-2xl font-bold">三大法人買賣超（總計）</h1>
            ...
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="px-4">法人類型</TableHead>
